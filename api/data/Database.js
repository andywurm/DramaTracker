...
module.exports = [
    ...
    ,
    {
        ...
        photo:  'YourEyesTellPoster.jpg',
        cast: ['Yokohama Ryusei','Yoshitaka Yuriko','Machida Keita'],
        type: 'movie',
        description: 'Rui is an ex-kickboxer who has broken away from his shady past and now lives a lonely life. While at work, he meets Akari, a blind yet cheerful girl. A tragic accident lead to Akaris blindness, but she clings to life and the smaller pleasures it can still afford her. Akari has also lost her family just like Rui. The two begin to learn more about each other and eventually fall in love.'
    }
    ,
    {
        title: 'Avalanche',
        genre: ['Crime', 'Mystery','Action'],
        photo: 'AvalanchePoster.jpg',
        cast: ['Ayano Go','Fukushi Sota'],
        type: 'show',
        description: 'An underground group of special investigators, Avalanche tracks down criminals who conspire with government officials to break the law. The group makes up their own way of serving justice. Their goal is to socially obliterate the guilty. They will make their victims confess to wrong doing on social media livestreams which guarantees them exposure.'
    }
    ,
    {
    ...
    ,
    {
        ...
        cast: ['Sawajiri Erika','Nishikido Ryo'],
        type: 'show',
        description: 'Fifteen-year-old Ikeuchi Aya is an ordinary girl, soon to be high school student and daughter of a family who works at a tofu shop. As time passes, unusual things start happening to Aya. She begins falling down often and walking strangely. Her mother Shioka, takes Aya to see the doctor, and he informs Shioka that Aya has spinocerebellar degeneration - a rare disease where the cerebellum of the brain gradually deteriorates to the point where the victim cannot walk, speak, write, or eat. It is a cruel disease, as it does not affect the mind. The story revolves around the time when Aya was 14-20.'
    }
    ,
    {
        title: 'Cherry Magic',
        genre: ['Romance','Office','Comedy'],
        photo: 'CherryMagicPoster.jpg',
        cast: ['Machida Keita','Akaso Eiji'],
        type: 'show',
        description: 'At the age of 30, Kiyoshi Adachi gains a magical power that allows him to read other peoples mind by touching them. Things change when he accidentally touches Yuichi Kurosawa and reads his mind. Here he finds out that Kurosawa might be in love with him?'
    }
    ,
    {
        title: 'Drowning Love',
    ...
    ,
    {
        title: 'MIU404',
        genre: ['Crime','Mystery','Action'],
        photo: 'MIU404Poster.jpg',
        cast: ['Hoshino Gen','Ayano Go','Aso Kumiko','Suda Masaki'],
        type: 'show',
        description: 'A skilled detective named Shima Kazumi in the Mobile Investigative Unit is forced to pair up with a rookie police officer, Ibuki Ai, to solve cases within 24 hours. The two go on many adventures leading to them meeting new and interesting people and also solving crimes in unorthodox ways.'
    }
    ,
    {
        title: 'Pink and Gray',
        genre: ['Psychological','Mystery'],
        photo: 'PinkAndGrayPoster.jpg',
        cast: ['Suda Masaki','Nakajima Yuto','Kishii Yukino'],
        type: 'movie',
        description: 'Rengo Shiraki, a popular movie star, is found dead-along with a suicide note-by his best friend, Daiki Kawada, a struggling actor who dreams of achieving the fame and fortune Rengo has enjoyed. The suicide note prompts Daiki to write and publish Rengos biography, the success of which unwittingly throws Daiki into the limelight. Struggling to come to terms with Rengos suicide as well as with fame he can not really call his own, Daiki sets out to discover the truth behind his friends death.'
    }
    ,
    {
        title: 'Cursed In Love',
        genre: ['Romance','Mystery'],
        photo: 'WatashitachiWaDoukaShiteruPoster.jpg',
        cast: ['Yokohama Ryusei','Hamabe Minami','Kishii Yukino'],
        type: 'show',
        description: 'An artisans daughter, Hanaoka Nao, tries to find out who framed her mother for murder by marrying Tsubaki Takatsuki, the son of the man who was killed. While on her journey to find the truth, she is thrusted into Tsubakis weird family dynamics. The head matron of the house is trying her best to get rid of Nao. '
    }
    ,
    {
        title: 'Kyou Kara Ore Wa',
        genre: ['Comedy','School','Action'],
        photo: 'KyouKaraOreWaPoster.jpg',
        cast: ['Kaku Kento','Ito Kentaro','Hashimoto Kanna','Nakano Taiga'],
        type: 'show',
        description: 'Mitsuhashi Takashi and Itou Shinji are tired of their old boring life. When entering high school they decide to strip their past lives and become delinquints. From that day on they change the way they dress and act in order to fit this new aesthetic. This brings them to meet people they would have never met as they are now forced to fight for their school and their own honor.'
    }
    ,
    {
        title: 'Saiai',
        genre: ['Crime','Mystery','Family'],
        photo: 'SaiaiPoster.jpg',
        cast: ['Yoshitaka Yuriko','Iura Arata','Matsushita Kouhei'],
        type: 'show',
        description:'Sanada Rio is a wealthy businesswoman who suddenly became an important reference for a murder case. A detective named Miyazaki Daiki, who is Rios first love, is trying to pursue the truth of the case. Rios lawyer who wants to protect Rio by all means will do whatever it takes to keep her and her family safe.'
    }
    ,
    {
        title: 'Theatre',
        ...
        cast: ['Yamazaki Kento','Matsuoka Mayu'],
        type: 'movie',
        description:'The director of a theatre company is in crisis. He is running out of money and time and his actors have lost confidence in him and his work. One day, while walking down the street he meets a woman wearing the same shoes as him, immediately sparking chemistry between the two.'
    }
    ,
    {
        title: 'Hirugao',
        genre: ['Romance','Family','Life'],
        photo: 'HirugaoPoster.jpg',
        cast: ['Ueto Aya','Saito Takumi','Kichise Michiko'],
        type: 'show',
        description: 'Sawa Sasamoto is a housewife. Her and her husband have a good relationsip but it is not very romantic. While at work there is an incident. She meets Rikako Takikawa is also a housewife and involved in an extra marital affair. Soon after their "friendship" begins, Rikako leads Sawa to have an affair with another man. '
    }
    ,
    {
        title: 'Hana Yori Dango',
        genre: ['Romance','School'],
        photo: 'HanaYoriDangoPoster.jpg',
        cast: ['Matsumoto Jun','Inoue Mao','Oguri Shun'],
        type: 'show',
    ...
    ,
    {
        ...
        cast: ['Ishihara Satomi','Matsumoto Jun'],
        type: 'show',
        description: 'A culinary students one-sided, unrequited love for his once high school sweetheart, is bittersweet. His love for her and her love for chocolate lead him on a quest to creating the perfect chocolate just for her. He flies to Paris to learn skills under a very famous chocolatier and when he turns to Japan, he opens a shop in hopes of meeting his high school sweetheart once again.'
    }
    , 
    {
        title: 'Unnatural',
        ...
        cast: ['Ishihara Satomi','Kubota Masataka','Iura Arata'],
        type: 'show',
        description: 'Mikoto Misumi Mikoto Misumi is a forensic doctor working at the Unnatural Death Investigation Laboratory (UDI Lab), a facility recently established by the Ministry of Health, Labour and Welfare. Together with her colleagues, she solves cases involving deaths arising from unnatural circumstances.' 
    }
    , 
    {
        ...
        cast: ['Suda Masaki','Kamiki Ryunosuke','Nakano Taiga','Arimura Kasumi'],
        type: 'show',
    ...
    ,
    {
        ...
        cast: ['Matsumoto Jun','Kishii Yukino'],
        type: 'show',
